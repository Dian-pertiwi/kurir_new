...
<section id="form_pengiriman" class="form_pengiriman section">
    ...
    ?>
            ...
            <div class="mb-3">
                ...
                <select name="kecamatan_pengirim" id="kecamatan_pengirim" class="form-control" required></select>
            </div>
            <div class="mb-3">
    ...
    ?>
            ...
            <div class="mb-3">
                ...
                <select name="kecamatan_penerima" id="kecamatan_penerima" class="form-control" required></select>
            </div>
    ...
    ?>
        ...
        $query = $conn->query("SELECT 
            t.id_tarif, 
            kab_asal.nama_kabupaten AS asal, 
            kab_tujuan.nama_kabupaten AS tujuan, 
            t.tarif
        FROM tbl_tarif t
        JOIN tbl_kabupaten kab_asal ON t.id_kab_asal = kab_asal.id_kab
        JOIN tbl_kabupaten kab_tujuan ON t.id_kab_tujuan = kab_tujuan.id_kab
        ORDER BY kab_asal.nama_kabupaten, kab_tujuan.nama_kabupaten");
